amespace :qanda do
  ...
  task :create_liferay_folders_41_45 => :environment do
    ...
    liferay_grantee_folder_id = 17874
    liferay_project_folder_id = 0
    
    @renewals_list = McocRenewal.where(:id => 41..45).order('grantee_name ASC, project_name ASC') 
